...
import { Train, LayoutDashboard, Cpu, Volume2, TrainTrack, Database, Star, Layers } from "lucide-react";
...
const Layout = () => {
  ...
  const navItems = [
    ...
    { to: "/decoders", icon: Cpu, label: "Decoders" },
    { to: "/sound-projects", icon: Volume2, label: "Sonido" },
    { to: "/wishlist", icon: Star, label: "Deseos" },
      ...
      <footer className="bg-white border-t border-slate-200 py-4">
        <div className="max-w-7xl mx-auto px-6">
          <p className="font-mono text-xs text-slate-400 text-center uppercase tracking-widest">
            escalaN.es Colección &bull; Sistema de Gestión Digital &bull; App gratuita no comercial
          </p>
        </div>
      </footer>
    </div>
